...
pip install git+\[https://github.com/javalinL/Genome\_Standardizer\_Release.git]
(https://github.com/javalinL/Genome\_Standardizer\_Release.git)
...
gstd annotation.gff3 genome.fasta Target\_Prefix --save-log
...
gstd annotation.gff3 genome.fasta Target\_Prefix --longest --save-log
...
gstd subA.gff,subB.gff subA.fa,subB.fa Hybrid\_Species --add-prefix SubA\_,SubB\_
...
5\.<Prefix>.id\_list: A mapping dictionary bridging original erratic IDs to the new, clean standardized IDs.
